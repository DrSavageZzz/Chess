...
namespace Checkmate
{
    public partial class Chess : Form
    {
        ...
        */
        ...
        {
            board.SetCell(location.X, location.Y - 3, new Cell(location.X, location.Y-3, currentPiece));
            board.SetCell(location.X, location.Y - 2, new Cell(location.X, location.Y - 2, board.board[location.X,location.Y - 4].GetChessPiece()));
        }
        private void pieceClick(object sender, EventArgs e)
        {
            ...
            label1.Text = @"You clicked a square at location " + currentCell.RowNum + ", " + currentCell.ColNum;
            ...
            else if (PlayerHasMoved(clickedPiece) == false)
            {
                temp = clickedPiece;
                currentPiece = piece;
                clickedCell = currentCell;
            ...
            else
            {
                ...
                if (PlayerHasMoved(clickedPiece))
                {
